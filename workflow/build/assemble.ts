 ...
 *
 * Usage: node --loader ts-node/esm workflow/build/assemble.ts
 */
...
export const SKELETON_PATH = resolve(ROOT, 'workflow', 'source', 'skeleton.json');
export const OUTPUT_PATH = resolve(ROOT, 'generated', 'workflow', 'photography-weather-brief.json');
