...
import {
  ...
  evaluateKitRules,
  kitAdvisoryCard,
} from './format-email/kit-advisory.js';
import {
...
export { formatDebugEmail } from './format-email/debug-email.js';
export { buildKitTips, evaluateKitRules, type KitTip } from './format-email/kit-advisory.js';
export {
  nextDayHourlyOutlookSection,
  outdoorComfortLabel,
  outdoorComfortScore,
