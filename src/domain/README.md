...
- `sessions/`
  Built-in session evaluators (golden hour, blue hour, astro, mist, storm, urban, long-exposure, wildlife, seascape), cross-hour selection logic, and recommendation summary generation.
