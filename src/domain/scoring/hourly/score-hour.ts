...
import { outdoorComfortScore, outdoorComfortText, outdoorComfortDetail } from '../../../lib/outdoor-comfort.js';
...
export function scoreHour(p: ScoreHourParams): ScoreHourResult {
  ...
  const hour: ScoredHour = {
    ...
    comfortDetail: null,  // populated below after object construction
  };
  ...
  hour.comfortDetail = outdoorComfortDetail(comfortScore, hour);
