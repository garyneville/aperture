...
export function resolveEditorial(input: ResolveEditorialInput): ResolveEditorialOutput {
  ...
  return {
    editorial: {
      ...
      windowExplanation: resolvedComponents.windowExplanation ?? undefined,
      sessionComparison: resolvedComponents.sessionComparison ?? undefined,
      nextDayBridge: resolvedComponents.nextDayBridge ?? undefined,
      altLocationHook: resolvedComponents.altLocationHook ?? undefined,
