...
export function buildEditorialCandidate(
  ...
  return {
    ...
    windowExplanation: parsed.windowExplanation,
    sessionComparison: parsed.sessionComparison,
    nextDayBridge: parsed.nextDayBridge,
    altLocationHook: parsed.altLocationHook,
    normalizedAiText,
    factualCheck,
    editorialCheck,
