/**
 * Kit advisory - Cross-presenter utilities for kit recommendation logic.
 *
 * This module provides rule-based kit recommendation logic that is used
 * by multiple presenters (email, site) and is not specific to any single
 * output channel.
 */
...
/**
 * Builds kit tips based on weather conditions and windows.
 */
...
/**
 * Evaluates kit rules and returns debug trace information.
 */
